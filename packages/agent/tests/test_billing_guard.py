...
async def test_event_ingest_under_quota_allows():
    ...
    mock_repo = MagicMock()
    mock_repo.count_events_since = AsyncMock(return_value=50_000)
...
async def test_event_ingest_over_quota_no_payg_rejects():
    ...
    mock_repo = MagicMock()
    mock_repo.count_events_since = AsyncMock(return_value=110_000)
...
async def test_event_ingest_free_plan_uses_calendar_month():
    ...
    mock_repo = MagicMock()
    mock_repo.count_events_since = AsyncMock(return_value=100)
